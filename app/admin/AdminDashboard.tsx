                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {row.rankDelta > 0 ? (
                            <span
                              ...
                              title={`Op ${row.rankDelta} plads${row.rankDelta > 1 ? "er" : ""} (seneste time vs timen før)`}
                            >
                          ...
                          {row.rankDelta < 0 ? (
                            <span
                              ...
                              title={`Ned ${Math.abs(row.rankDelta)} plads${Math.abs(row.rankDelta) > 1 ? "er" : ""} (seneste time vs timen før)`}
                            >
